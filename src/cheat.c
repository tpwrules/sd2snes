...
void cheat_program() {
  ...
  cheat_enable(1);
  cheat_nmi_enable(romprops.has_sa1 ? 0 : CFG.enable_irq_hook);
  //cheat_nmi_enable(CFG.enable_irq_hook);
  cheat_irq_enable((romprops.has_sa1 || (romprops.has_gsu && !strncmp((char *)romprops.header.name, "DOOM", strlen("DOOM")))) ? 0 : CFG.enable_irq_hook);
