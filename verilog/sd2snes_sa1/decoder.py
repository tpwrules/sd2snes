...
mxTable = [
           ...
           Instruction(index=0x00, opcode=eOpcode.BRK, mode=eMode.StackInterrupt                  , operands=1, latency=7, prc=ePrc.B   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.SPC, imm=0, bnk=eBnk.Z, add=eAdd.SPL, mod=eMod.I, ind=0, lng=0, stk=1),
           ...
           Instruction(index=0x02, opcode=eOpcode.COP, mode=eMode.StackInterrupt                  , operands=1, latency=7, prc=ePrc.B   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.SPC, imm=0, bnk=eBnk.Z, add=eAdd.SPL, mod=eMod.I, ind=0, lng=0, stk=1),
           ...
           Instruction(index=0x0A, opcode=eOpcode.ASL, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x1A, opcode=eOpcode.INC, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x2A, opcode=eOpcode.ROL, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x3A, opcode=eOpcode.DEC, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x4A, opcode=eOpcode.LSR, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x6A, opcode=eOpcode.ROR, mode=eMode.Accumulator                     , operands=0, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.RMW, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xC0, opcode=eOpcode.CPY, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.X   , src=eReg.I   , dst=eReg.X   , load=0, store=0, ctl=0, grp=eGrp.CMP, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0xC1, opcode=eOpcode.CMP, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           ...
           Instruction(index=0xC3, opcode=eOpcode.CMP, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0xC4, opcode=eOpcode.CPY, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.X   , src=eReg.I   , dst=eReg.X   , load=1, store=0, ctl=0, grp=eGrp.CMP, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0xC5, opcode=eOpcode.CMP, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xC7, opcode=eOpcode.CMP, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xC9, opcode=eOpcode.CMP, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xCC, opcode=eOpcode.CPY, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.X   , src=eReg.I   , dst=eReg.X   , load=1, store=0, ctl=0, grp=eGrp.CMP, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0xCD, opcode=eOpcode.CMP, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xCF, opcode=eOpcode.CMP, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xD1, opcode=eOpcode.CMP, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0xD2, opcode=eOpcode.CMP, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0xD3, opcode=eOpcode.CMP, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xD5, opcode=eOpcode.CMP, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xD7, opcode=eOpcode.CMP, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xD9, opcode=eOpcode.CMP, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xDD, opcode=eOpcode.CMP, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xDF, opcode=eOpcode.CMP, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
