...
mxTable = [
           ...
           Instruction(index=0x43, opcode=eOpcode.EOR, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x45, opcode=eOpcode.EOR, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x47, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x4D, opcode=eOpcode.EOR, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x4F, opcode=eOpcode.EOR, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x51, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0x52, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x53, opcode=eOpcode.EOR, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x55, opcode=eOpcode.EOR, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x57, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x59, opcode=eOpcode.EOR, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x5D, opcode=eOpcode.EOR, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x5F, opcode=eOpcode.EOR, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
