...
mxTable = [
           ...
           Instruction(index=0x00, opcode=eOpcode.BRK, mode=eMode.StackInterrupt                  , operands=1, latency=7, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=1, store=1, ctl=1, grp=eGrp.SPC, imm=0, bnk=eBnk.Z, add=eAdd.SPL, mod=eMod.I, ind=0, lng=0, stk=1),
           Instruction(index=0x01, opcode=eOpcode.ORA, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           Instruction(index=0x02, opcode=eOpcode.COP, mode=eMode.StackInterrupt                  , operands=1, latency=7, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=1, store=1, ctl=1, grp=eGrp.SPC, imm=0, bnk=eBnk.Z, add=eAdd.SPL, mod=eMod.I, ind=0, lng=0, stk=1),
           Instruction(index=0x03, opcode=eOpcode.ORA, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x04, opcode=eOpcode.TSB, mode=eMode.DirectPage                      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=1, store=1, ctl=0, grp=eGrp.TST, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x05, opcode=eOpcode.ORA, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x07, opcode=eOpcode.ORA, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x09, opcode=eOpcode.ORA, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x0C, opcode=eOpcode.TSB, mode=eMode.Absolute                        , operands=2, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=1, store=1, ctl=0, grp=eGrp.TST, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x0D, opcode=eOpcode.ORA, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x0F, opcode=eOpcode.ORA, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x11, opcode=eOpcode.ORA, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0x12, opcode=eOpcode.ORA, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x13, opcode=eOpcode.ORA, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           Instruction(index=0x14, opcode=eOpcode.TRB, mode=eMode.DirectPage                      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=1, store=1, ctl=0, grp=eGrp.TST, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x15, opcode=eOpcode.ORA, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x17, opcode=eOpcode.ORA, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x19, opcode=eOpcode.ORA, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x1C, opcode=eOpcode.TRB, mode=eMode.Absolute                        , operands=2, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=1, store=1, ctl=0, grp=eGrp.TST, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x1D, opcode=eOpcode.ORA, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x1F, opcode=eOpcode.ORA, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),

           Instruction(index=0x20, opcode=eOpcode.JSR, mode=eMode.Absolute                        , operands=2, latency=6, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=1, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.P, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=1),
           Instruction(index=0x21, opcode=eOpcode.AND, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           Instruction(index=0x22, opcode=eOpcode.JSL, mode=eMode.AbsoluteLong                    , operands=3, latency=8, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=1, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=1),
           Instruction(index=0x23, opcode=eOpcode.AND, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x25, opcode=eOpcode.AND, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x27, opcode=eOpcode.AND, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x29, opcode=eOpcode.AND, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x2D, opcode=eOpcode.AND, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x2F, opcode=eOpcode.AND, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x31, opcode=eOpcode.AND, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0x32, opcode=eOpcode.AND, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x33, opcode=eOpcode.AND, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x35, opcode=eOpcode.AND, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x37, opcode=eOpcode.AND, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x39, opcode=eOpcode.AND, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x3D, opcode=eOpcode.AND, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x3F, opcode=eOpcode.AND, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),

           Instruction(index=0x40, opcode=eOpcode.RTI, mode=eMode.StackRTI                        , operands=0, latency=6, prc=ePrc.B   , src=eReg.I   , dst=eReg.I   , load=1, store=0, ctl=1, grp=eGrp.SPC, imm=0, bnk=eBnk.Z, add=eAdd.SPL, mod=eMod.I, ind=0, lng=0, stk=1),
           Instruction(index=0x41, opcode=eOpcode.EOR, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=1, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           ...
           Instruction(index=0x43, opcode=eOpcode.EOR, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x44, opcode=eOpcode.MVP, mode=eMode.Implied                         , operands=2, latency=1, prc=ePrc.B   , src=eReg.X   , dst=eReg.Y   , load=1, store=1, ctl=1, grp=eGrp.MOV, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x45, opcode=eOpcode.EOR, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x47, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x49, opcode=eOpcode.EOR, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x4C, opcode=eOpcode.JMP, mode=eMode.Absolute                        , operands=2, latency=3, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.P, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x4D, opcode=eOpcode.EOR, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x4F, opcode=eOpcode.EOR, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x51, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0x52, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x53, opcode=eOpcode.EOR, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           Instruction(index=0x54, opcode=eOpcode.MVN, mode=eMode.Implied                         , operands=2, latency=1, prc=ePrc.B   , src=eReg.X   , dst=eReg.Y   , load=1, store=1, ctl=1, grp=eGrp.MOV, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x55, opcode=eOpcode.EOR, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x57, opcode=eOpcode.EOR, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x59, opcode=eOpcode.EOR, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x5C, opcode=eOpcode.JMP, mode=eMode.AbsoluteLong                    , operands=3, latency=4, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           Instruction(index=0x5D, opcode=eOpcode.EOR, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x5F, opcode=eOpcode.EOR, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x61, opcode=eOpcode.ADC, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           Instruction(index=0x62, opcode=eOpcode.PER, mode=eMode.StackProgramCounterRelative     , operands=2, latency=6, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=1, ctl=0, grp=eGrp.STK, imm=0, bnk=eBnk.Z, add=eAdd.SMI, mod=eMod.I, ind=0, lng=0, stk=1),
           Instruction(index=0x63, opcode=eOpcode.ADC, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x65, opcode=eOpcode.ADC, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x67, opcode=eOpcode.ADC, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x69, opcode=eOpcode.ADC, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x6C, opcode=eOpcode.JMP, mode=eMode.AbsoluteIndirect                , operands=2, latency=5, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x6D, opcode=eOpcode.ADC, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x6F, opcode=eOpcode.ADC, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x71, opcode=eOpcode.ADC, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0x72, opcode=eOpcode.ADC, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0x73, opcode=eOpcode.ADC, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x75, opcode=eOpcode.ADC, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x77, opcode=eOpcode.ADC, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0x79, opcode=eOpcode.ADC, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x7C, opcode=eOpcode.JMP, mode=eMode.AbsoluteIndexedIndirect         , operands=2, latency=6, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.P, add=eAdd.O16, mod=eMod.X, ind=1, lng=0, stk=0),
           Instruction(index=0x7D, opcode=eOpcode.ADC, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0x7F, opcode=eOpcode.ADC, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x8E, opcode=eOpcode.STX, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.X   , src=eReg.X   , dst=eReg.I   , load=0, store=1, ctl=0, grp=eGrp.PHS, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           Instruction(index=0x8F, opcode=eOpcode.STA, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=0, store=1, ctl=0, grp=eGrp.PHS, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0x9F, opcode=eOpcode.STA, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.I   , load=0, store=1, ctl=0, grp=eGrp.PHS, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xA1, opcode=eOpcode.LDA, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           ...
           Instruction(index=0xA3, opcode=eOpcode.LDA, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xA5, opcode=eOpcode.LDA, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xA7, opcode=eOpcode.LDA, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xA9, opcode=eOpcode.LDA, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xAD, opcode=eOpcode.LDA, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xAF, opcode=eOpcode.LDA, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xB1, opcode=eOpcode.LDA, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0xB2, opcode=eOpcode.LDA, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0xB3, opcode=eOpcode.LDA, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xB5, opcode=eOpcode.LDA, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xB7, opcode=eOpcode.LDA, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xB9, opcode=eOpcode.LDA, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xBD, opcode=eOpcode.LDA, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xBF, opcode=eOpcode.LDA, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xCF, opcode=eOpcode.CMP, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.CMP, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xD4, opcode=eOpcode.PEI, mode=eMode.StackDirectPageIndirect         , operands=1, latency=6, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=1, store=1, ctl=0, grp=eGrp.STK, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=1),
           ...
           Instruction(index=0xDC, opcode=eOpcode.JMP, mode=eMode.AbsoluteIndirectLong            , operands=2, latency=6, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=0, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xDF, opcode=eOpcode.CMP, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.I   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.CMP, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xE1, opcode=eOpcode.SBC, mode=eMode.DirectPageIndexedIndirectX      , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=1, lng=0, stk=0),
           ...
           Instruction(index=0xE3, opcode=eOpcode.SBC, mode=eMode.StackRelative                   , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xE5, opcode=eOpcode.SBC, mode=eMode.DirectPage                      , operands=1, latency=3, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xE7, opcode=eOpcode.SBC, mode=eMode.DirectPageIndirectLong          , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xE9, opcode=eOpcode.SBC, mode=eMode.Immediate                       , operands=1, latency=2, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.PRI, imm=1, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xEB, opcode=eOpcode.XBA, mode=eMode.Implied                         , operands=0, latency=3, prc=ePrc.B   , src=eReg.A   , dst=eReg.A   , load=0, store=0, ctl=0, grp=eGrp.XCH, imm=0, bnk=eBnk.Z, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xED, opcode=eOpcode.SBC, mode=eMode.Absolute                        , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.I, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xEF, opcode=eOpcode.SBC, mode=eMode.AbsoluteLong                    , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.I, ind=0, lng=1, stk=0),
           ...
           Instruction(index=0xF1, opcode=eOpcode.SBC, mode=eMode.DirectPageIndirectIndexedY      , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=0, stk=0),
           Instruction(index=0xF2, opcode=eOpcode.SBC, mode=eMode.DirectPageIndirect              , operands=1, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.I, ind=1, lng=0, stk=0),
           Instruction(index=0xF3, opcode=eOpcode.SBC, mode=eMode.StackRelativeIndirectIndexedY   , operands=1, latency=7, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.SPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xF5, opcode=eOpcode.SBC, mode=eMode.DirectPageIndexedX              , operands=1, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xF7, opcode=eOpcode.SBC, mode=eMode.DirectPageIndirectLongIndexedY  , operands=1, latency=6, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.Z, add=eAdd.DPR, mod=eMod.P, ind=1, lng=1, stk=0),
           ...
           Instruction(index=0xF9, opcode=eOpcode.SBC, mode=eMode.AbsoluteIndexedY                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.Y, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xFC, opcode=eOpcode.JSR, mode=eMode.AbsoluteIndexedIndirect         , operands=2, latency=8, prc=ePrc.W   , src=eReg.I   , dst=eReg.I   , load=0, store=1, ctl=1, grp=eGrp.JMP, imm=0, bnk=eBnk.P, add=eAdd.O16, mod=eMod.X, ind=1, lng=0, stk=1),
           Instruction(index=0xFD, opcode=eOpcode.SBC, mode=eMode.AbsoluteIndexedX                , operands=2, latency=4, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.D, add=eAdd.O16, mod=eMod.X, ind=0, lng=0, stk=0),
           ...
           Instruction(index=0xFF, opcode=eOpcode.SBC, mode=eMode.AbsoluteLongIndexedX            , operands=3, latency=5, prc=ePrc.M   , src=eReg.A   , dst=eReg.A   , load=1, store=0, ctl=0, grp=eGrp.PRI, imm=0, bnk=eBnk.O, add=eAdd.O16, mod=eMod.X, ind=0, lng=1, stk=0),
